...
**Extreme Event Profile and Weekly/Monthly Extremeness Metrics (ERA5/OISST)**
```
...
```
**Daily Data and Extreme Threshold (ERA5/OISST)**
```
...
```
**Weekly Data and Extreme Threshold (ERA5)**
```
...
```
**Daily Data and Extreme Threshold (ECMWF-hindcast ver.2016/ver.2024)**
```
